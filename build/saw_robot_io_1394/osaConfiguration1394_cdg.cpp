...
// cisst version: 1.1.0
// source file: /home/autocam/dvrk2.1_ws/src/cisst-saw/sawRobotIO1394/components/code/osaConfiguration1394.cdg
...
sawRobotIO1394::osaPot1394Configuration::osaPot1394Configuration(const osaPot1394Configuration & other):
    ...
    , DigPotResolution(other.DigPotResolution)
    , DigPotMin(other.DigPotMin)
{}
...
void sawRobotIO1394::osaPot1394Configuration::SerializeRaw(std::ostream & outputStream__cdg) const
{
    ...
    cmnSerializeRaw(outputStream__cdg, this->DigPotResolution);
    cmnSerializeRaw(outputStream__cdg, this->DigPotMin);
}
...
void sawRobotIO1394::osaPot1394Configuration::DeSerializeRaw(std::istream & inputStream__cdg)
{
    ...
    cmnDeSerializeRaw(inputStream__cdg, this->DigPotResolution);
    cmnDeSerializeRaw(inputStream__cdg, this->DigPotMin);
}
...
void sawRobotIO1394::osaPot1394Configuration::Copy(const sawRobotIO1394::osaPot1394Configuration & source__cdg) {
    ...
    cmnData<double >::Copy(this->DigPotResolution, source__cdg.DigPotResolution);
    cmnData<double >::Copy(this->DigPotMin, source__cdg.DigPotMin);
}
void sawRobotIO1394::osaPot1394Configuration::SerializeBinary(std::ostream & outputStream__cdg) const CISST_THROW(std::runtime_error) {
    ...
    cmnData<double >::SerializeBinary(this->DigPotResolution, outputStream__cdg);
    cmnData<double >::SerializeBinary(this->DigPotMin, outputStream__cdg);
}
void sawRobotIO1394::osaPot1394Configuration::DeSerializeBinary(std::istream & inputStream__cdg,
    ...
    cmnData<double >::DeSerializeBinary(this->DigPotResolution, inputStream__cdg, localFormat, remoteFormat);
    cmnData<double >::DeSerializeBinary(this->DigPotMin, inputStream__cdg, localFormat, remoteFormat);
}
void sawRobotIO1394::osaPot1394Configuration::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const CISST_THROW(std::runtime_error) {
    ...
    someData__cdg = true;
    cmnData<double >::SerializeText(this->DigPotResolution, outputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
    someData__cdg = true;
    cmnData<double >::SerializeText(this->DigPotMin, outputStream__cdg, delimiter__cdg);
}
std::string sawRobotIO1394::osaPot1394Configuration::SerializeDescription(const char delimiter__cdg, const std::string & userDescription__cdg) const {
    ...
    someData__cdg = true;
    description__cdg << cmnData<double >::SerializeDescription(this->DigPotResolution, delimiter__cdg, prefix__cdg + "DigPotResolution");
    if (someData__cdg) {
        description__cdg << delimiter__cdg;
    }
    someData__cdg = true;
    description__cdg << cmnData<double >::SerializeDescription(this->DigPotMin, delimiter__cdg, prefix__cdg + "DigPotMin");
    return description__cdg.str();
}
void sawRobotIO1394::osaPot1394Configuration::DeSerializeText(std::istream & inputStream__cdg,
    ...
    someData__cdg = true;
    cmnData<double >::DeSerializeText(this->DigPotResolution, inputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        cmnDataDeSerializeTextDelimiter(inputStream__cdg, delimiter__cdg, "sawRobotIO1394::osaPot1394Configuration");
    }
    someData__cdg = true;
    cmnData<double >::DeSerializeText(this->DigPotMin, inputStream__cdg, delimiter__cdg);
}
std::string sawRobotIO1394::osaPot1394Configuration::HumanReadable(void) const {
    ...
    description__cdg << "  DigPotResolution:" << cmnData<double >::HumanReadable(this->DigPotResolution);
    description__cdg << "  DigPotMin:" << cmnData<double >::HumanReadable(this->DigPotMin);
    return description__cdg.str();
}
bool sawRobotIO1394::osaPot1394Configuration::ScalarNumberIsFixed(void) const {
    return true
           ...
           && cmnData<double >::ScalarNumberIsFixed(this->DigPotResolution)
           && cmnData<double >::ScalarNumberIsFixed(this->DigPotMin)
    ;
}
size_t sawRobotIO1394::osaPot1394Configuration::ScalarNumber(void) const {
    return 0
           ...
           + cmnData<double >::ScalarNumber(this->DigPotResolution)
           + cmnData<double >::ScalarNumber(this->DigPotMin)
    ;
}
std::string sawRobotIO1394::osaPot1394Configuration::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const CISST_THROW(std::out_of_range) {
    ...
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<double >::ScalarNumber(this->DigPotResolution);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<double >::ScalarDescription(this->DigPotResolution, index_cdg - baseIndex__cdg, prefix__cdg + "DigPotResolution");
    }
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<double >::ScalarNumber(this->DigPotMin);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<double >::ScalarDescription(this->DigPotMin, index_cdg - baseIndex__cdg, prefix__cdg + "DigPotMin");
    }
    baseIndex__cdg = currentMaxIndex__cdg;
...
double sawRobotIO1394::osaPot1394Configuration::Scalar(const size_t index_cdg) const CISST_THROW(std::out_of_range) {
    ...
    currentMaxIndex__cdg += cmnData<double >::ScalarNumber(this->DigPotResolution);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<double >::Scalar(this->DigPotResolution, index_cdg - baseIndex__cdg);
    }
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<double >::ScalarNumber(this->DigPotMin);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<double >::Scalar(this->DigPotMin, index_cdg - baseIndex__cdg);
    }
    baseIndex__cdg = currentMaxIndex__cdg;
...
void sawRobotIO1394::osaPot1394Configuration::SerializeTextJSON(Json::Value & jsonValue) const {
    ...
    cmnDataJSON<double >::SerializeText(this->DigPotResolution, jsonValue["DigPotResolution"]);
    cmnDataJSON<double >::SerializeText(this->DigPotMin, jsonValue["DigPotMin"]);
}
template<>
...
void sawRobotIO1394::osaPot1394Configuration::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    field__cdg = jsonValue["DigPotResolution"];
    if (!field__cdg.empty()) {
        cmnDataJSON<double >::DeSerializeText(this->DigPotResolution, field__cdg);
    } else {
        cmnThrow("cmnDataJson<double>::DeSerializeText: empty JSON value for: DigPotResolution");
    };
    field__cdg = jsonValue["DigPotMin"];
    if (!field__cdg.empty()) {
        cmnDataJSON<double >::DeSerializeText(this->DigPotMin, field__cdg);
    } else {
        cmnThrow("cmnDataJson<double>::DeSerializeText: empty JSON value for: DigPotMin");
    };
}
#endif // CISST_HAS_JSON
