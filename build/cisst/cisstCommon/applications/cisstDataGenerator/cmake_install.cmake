# Install script for directory: /home/autocam/dvrk2.1_ws/src/cisst-saw/cisst/cisstCommon/applications/cisstDataGenerator
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "cisstCommon" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/autocam/dvrk2.1_ws/devel/.private/cisst/bin/cisstDataGenerator")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/cisstDataGenerator" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/cisstDataGenerator")
