...
void prmInputDataQtWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        prmInputDataQtWidget *_t = static_cast<prmInputDataQtWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject prmInputDataQtWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_prmInputDataQtWidget.data,
      qt_meta_data_prmInputDataQtWidget,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        prmInputDataQtWidgetComponent *_t = static_cast<prmInputDataQtWidgetComponent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (prmInputDataQtWidgetComponent::*_t)(prmInputData );
...
const QMetaObject prmInputDataQtWidgetComponent::staticMetaObject = {
    { &prmInputDataQtWidget::staticMetaObject, qt_meta_stringdata_prmInputDataQtWidgetComponent.data,
      qt_meta_data_prmInputDataQtWidgetComponent,  qt_static_metacall, nullptr, nullptr}
};
