...
// cisst version: 1.1.0
// source file: /home/autocam/dvrk2.1_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmCartesianImpedanceGains.cdg
...
prmCartesianImpedanceGains::prmCartesianImpedanceGains(void):
    ...
    , mForcePosition()
    , mTorqueOrientation()
    , mPositionDeadbandPos(0.0)
    , mPositionDeadbandNeg(0.0)
    , mPositionStiffnessPos(0.0)
    , mPositionStiffnessNeg(0.0)
    , mPositionDampingPos(0.0)
    , mPositionDampingNeg(0.0)
    , mForceBiasPos(0.0)
    , mForceBiasNeg(0.0)
    , mOrientationDeadbandPos(0.0)
    , mOrientationDeadbandNeg(0.0)
    , mOrientationStiffnessPos(0.0)
    , mOrientationStiffnessNeg(0.0)
    , mOrientationDampingPos(0.0)
    , mOrientationDampingNeg(0.0)
    , mTorqueBiasPos(0.0)
    , mTorqueBiasNeg(0.0)
{}
