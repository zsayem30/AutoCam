...
struct prmCartesianImpedanceGains_
{
  ...
  prmCartesianImpedanceGains_(const ContainerAllocator& _alloc)
    ...
    , PosDeadbandPos(_alloc)
    , PosDeadbandNeg(_alloc)
    , PosStiffPos(_alloc)
    , PosStiffNeg(_alloc)
    ...
    , ForceBiasPos(_alloc)
    , ForceBiasNeg(_alloc)
    , OriDeadbandPos(_alloc)
    , OriDeadbandNeg(_alloc)
    , OriStiffPos(_alloc)
    , OriStiffNeg(_alloc)
  ...
  _TorqueOrientation_type TorqueOrientation;
   ...
   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _PosDeadbandPos_type;
  _PosDeadbandPos_type PosDeadbandPos;

   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _PosDeadbandNeg_type;
  ...
  _ForceBiasNeg_type ForceBiasNeg;
   ...
   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _OriDeadbandPos_type;
  _OriDeadbandPos_type OriDeadbandPos;

   typedef  ::geometry_msgs::Vector3_<ContainerAllocator>  _OriDeadbandNeg_type;
...
bool operator==(const ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator1> & lhs, const ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.ForceOrientation == rhs.ForceOrientation &&
    lhs.ForcePosition == rhs.ForcePosition &&
    lhs.TorqueOrientation == rhs.TorqueOrientation &&
    lhs.PosDeadbandPos == rhs.PosDeadbandPos &&
    lhs.PosDeadbandNeg == rhs.PosDeadbandNeg &&
    lhs.PosStiffPos == rhs.PosStiffPos &&
    lhs.PosStiffNeg == rhs.PosStiffNeg &&
    lhs.PosDampingPos == rhs.PosDampingPos &&
    lhs.PosDampingNeg == rhs.PosDampingNeg &&
    lhs.ForceBiasPos == rhs.ForceBiasPos &&
    lhs.ForceBiasNeg == rhs.ForceBiasNeg &&
    lhs.OriDeadbandPos == rhs.OriDeadbandPos &&
    lhs.OriDeadbandNeg == rhs.OriDeadbandNeg &&
    lhs.OriStiffPos == rhs.OriStiffPos &&
    lhs.OriStiffNeg == rhs.OriStiffNeg &&
    lhs.OriDampingPos == rhs.OriDampingPos &&
    lhs.OriDampingNeg == rhs.OriDampingNeg &&
    lhs.TorqueBiasPos == rhs.TorqueBiasPos &&
    lhs.TorqueBiasNeg == rhs.TorqueBiasNeg;
}
...
struct MD5Sum< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe7496f2f1492fd45ULL;
  static const uint64_t static_value2 = 0x4255a51e4f99f687ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.PosDeadbandPos);
      stream.next(m.PosDeadbandNeg);
      ...
      stream.next(m.OriDeadbandPos);
      stream.next(m.OriDeadbandNeg);
...
struct Printer< ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cisst_msgs::prmCartesianImpedanceGains_<ContainerAllocator>& v)
  {
    ...
    s << indent << "PosDeadbandPos: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.PosDeadbandPos);
    s << indent << "PosDeadbandNeg: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.PosDeadbandNeg);
    ...
    s << indent << "OriDeadbandPos: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.OriDeadbandPos);
    s << indent << "OriDeadbandNeg: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ", v.OriDeadbandNeg);
